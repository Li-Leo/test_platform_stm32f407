...
//rely on the RTC chip, because the weekday and leap year is calculated by RTC
...
//get current time
const DateTimeStruct* ssz_time_now(void);
...
*/
int ssz_time_format(char* str, int str_size, const char* format, const DateTimeStruct *time);
