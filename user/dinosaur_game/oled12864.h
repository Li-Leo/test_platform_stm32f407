...
#define OLED_SCLK_Clr() HAL_GPIO_WritePin(GPIOC, GPIO_PIN_4, GPIO_PIN_RESET) //GPIO_ResetBits(GPIOA,GPIO_Pin_5)//SCL
#define OLED_SCLK_Set() HAL_GPIO_WritePin(GPIOC, GPIO_PIN_4, GPIO_PIN_SET) //GPIO_SetBits(GPIOA,GPIO_Pin_5)

#define OLED_SDIN_Clr() HAL_GPIO_WritePin(GPIOC, GPIO_PIN_5, GPIO_PIN_RESET) // GPIO_ResetBits(GPIOA,GPIO_Pin_7)//SDA
#define OLED_SDIN_Set() HAL_GPIO_WritePin(GPIOC, GPIO_PIN_5, GPIO_PIN_SET) // GPIO_SetBits(GPIOA,GPIO_Pin_7)
...
void oled_show_string(u8 x,u8 y, u8 *p,u8 Char_Size);
